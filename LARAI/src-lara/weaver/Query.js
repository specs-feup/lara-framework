 ...
 * @param {String} [traversal = TraversalType.PREORDER] - AST traversal type, according to weaver.TraversalType
 */
Query.search = function (type, filter, traversal) {
 ...
 */
Query.searchFrom = function ($baseJp, type, filter, traversal) {
 ...
 * @param {String} [traversal = TraversalType.PREORDER] - AST traversal type, according to weaver.TraversalType
 */
Query.searchFromInclusive = function ($baseJp, type, filter, traversal) {
