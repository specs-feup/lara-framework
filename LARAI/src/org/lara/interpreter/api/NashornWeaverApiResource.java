 ...
 *
 */
public enum NashornWeaverApiResource implements LaraResourceProvider {
    ...
    private static final String BASE_PACKAGE = "nashorn/weaver/";

    /**
     * @param resource
     */
    private NashornWeaverApiResource(String resource) {
