...
public class ExprCall extends Expression implements IElement {
    ...
    public ExprCall(Element e,
        ...
        for (int i = 0; i < e.getAttributes().getLength(); i++) {
            ...
            if (a.getNodeName().equals("comment")) {
                ...
                throw new Exception(
                        "Unexpected attribute in Node ExprCall: " + e.getAttributes().item(0).getNodeName());
        }
    ...
    public void visitDepthFirst(Visitor visitor) {
        ...
        arguments.stream().forEach(node -> node.visitDepthFirst(visitor));

        if (method != null) {
            method.visitDepthFirst(visitor);
        }
