...
public class JavaCCLaraParser {

    public JsonObject parseFile(File sourceFile) {
        return parseFile(SpecsIo.toInputStream(sourceFile), SpecsIo.getCanonicalPath(sourceFile));
    }

    public JsonObject parseFile(InputStream code, String codeSource) {
