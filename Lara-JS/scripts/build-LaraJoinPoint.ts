...
import { convertSpecification, type ConvertedJoinpoint, type JSON_LanguageSpecification } from "./convert-joinpoint-specification.ts";

import { generateJoinpoints, generateEnums } from "./generate-ts-joinpoints.ts";

function buildLaraJoinPoint(inputFileName: string, outputFileName: string) {
  console.log("Hello from build-LaraJoinPoint.ts");
  ...
  fs.writeSync(
    outputFile,
    `//////////////////////////////////////////////////////
// This file is generated by build-LaraJoinPoint.ts //
//////////////////////////////////////////////////////
...
function promoteToStringFromAttributeToAction(specification: JSON_LanguageSpecification) {
...
function generateJoinpointWrapper(joinpoints: ConvertedJoinpoint[], outputFile: number) {
  fs.writeSync(
    outputFile,
    `/**
