...
import { laraGetter } from "../lara/core/LaraCore.ts";
import Accumulator from "../lara/util/Accumulator.ts";
import { type JpFilterRules } from "../lara/util/JpFilter.ts";
import JoinPoints from "./JoinPoints.ts";
import { TraversalType } from "./TraversalType.ts";
import Weaver from "./Weaver.ts";
import JpPredicate from "./predicate/JpPredicate.ts";
import StringPredicate from "./predicate/StringPredicate.ts";
import TypePredicate from "./predicate/TypePredicate.ts";
