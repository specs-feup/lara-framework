...
export default class Query {
    ...
    */
    static search(type: string, filter: any, traversal: any) {
    ...
    * @return {weaver.Selector} the results of the search.
    */
    static searchFrom($baseJp: any, type: string, filter: any, traversal: any) {
    ...
    * @return {weaver.Selector} the results of the search.
    */
    static searchFromInclusive($baseJp: any, type: string, filter: any, traversal: any) {
    ...
    */
    static childrenFrom($baseJp: any, type: string, filter: any) {
        // These rules will be used to create a lara.util.JpFilter instance, please refer to that class for details on what kinds of rules are supported.
    ...
    * @returns {weaver.Selector} the results of the search.
    */
    static scopeFrom($baseJp: any, type: string, filter: any) {
        // These rules will be used to create a lara.util.JpFilter instance, please refer to that class for details on what kinds of rules are supported.
 ...
 * @returns {weaver.Selector} the results of the search.
 */
function search(type: string, filter: any, traversal: any) {
 ...
 * @returns {weaver.Selector} the results of the search.
 */
function searchFrom($baseJp: any, type: string, filter: any, traversal: any) {
 ...
 * @returns {weaver.Selector} the results of the search.
 */
function searchFromInclusive($baseJp: any, type: string, filter: any, traversal: any) {
