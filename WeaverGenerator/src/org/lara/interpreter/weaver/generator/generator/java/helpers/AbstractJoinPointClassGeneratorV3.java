 ...
 */
public class AbstractJoinPointClassGeneratorV3 extends GeneratorHelper {

    private final JoinPointType joinPoint;
    private final JoinPointClass joinPointV2;

    protected AbstractJoinPointClassGeneratorV3(JavaAbstractsGenerator javaGenerator, JoinPointType joinPoint, LanguageSpecificationV2 langSpec) {
        super(javaGenerator);
        this.joinPoint = joinPoint;
        this.joinPointV2 = langSpec.getJoinPoint(joinPoint.getClazz());
    }
     ...
     * @return
     */
    public static JavaClass generate(JavaAbstractsGenerator javaGenerator, JoinPointType joinPoint, LanguageSpecificationV2 langSpec) {
        final AbstractJoinPointClassGeneratorV3 gen = new AbstractJoinPointClassGeneratorV3(javaGenerator, joinPoint, langSpec);
        return gen.generate();
    }
    ...
    public JavaClass generate() {
        ...
        GeneratorUtils.createSelectByNameV3(javaC, joinPointV2, superTypeName, isFinal);
