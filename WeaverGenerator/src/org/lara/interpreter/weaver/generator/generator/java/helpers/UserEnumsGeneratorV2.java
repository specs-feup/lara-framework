...
public class UserEnumsGeneratorV2 extends GeneratorHelper {
     ...
     * @return
     */
    protected UserEnumsGeneratorV2(JavaAbstractsGenerator javaGenerator, EnumDef enumDef) {
        super(javaGenerator);
    ...
    public static JavaEnum generate(JavaAbstractsGenerator javaGenerator, EnumDef enumDef) {
        var gen = new UserEnumsGeneratorV2(javaGenerator, enumDef);
        return gen.generate();
    }
