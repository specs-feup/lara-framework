    ...
    public void define() {
        ...
        global("LaraJoinPoint")
            ...
            .attribute("equals")
                .param("jp", THIS)
                .returns(BOOLEAN)
            .attribute("compareNodes")
                .tooltip("Compares this join point with another join point for identity (i.e., whether they represent the same AST node)")
                .param("aJoinPoint", jpRef("LaraJoinPoint"))
                .returns(BOOLEAN)
            .attribute("same")
                .tooltip("Compares this join point with another join point for identity (i.e., whether they represent the same AST node)")
                .param("other", jpRef("LaraJoinPoint"))
                .returns(BOOLEAN)
