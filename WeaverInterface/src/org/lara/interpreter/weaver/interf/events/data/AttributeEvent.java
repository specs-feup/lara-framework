...
public class AttributeEvent extends BaseEvent {
    private ALaraJoinPoint<?, ?> target;
    private String attribute;

    private List<Object> arguments;
    private Optional<Object> result;

    public AttributeEvent(Stage stage, ALaraJoinPoint<?, ?> target, String attribute, List<Object> arguments,
     ...
     * @return the target
     */
    public ALaraJoinPoint<?, ?> getTarget() {
        return target;
    }
