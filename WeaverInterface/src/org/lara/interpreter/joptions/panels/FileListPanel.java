...
public class FileListPanel extends KeyPanel<FileList> {
     ...
     * @param fileKey
     * @param data
     * @param fileSelectionMode See {@link JFileChooser#setFileSelectionMode(int)}
     * @param extensions
     */
    public FileListPanel(DataKey<FileList> key, DataKey<File> fileKey, DataStore data, int fileSelectionMode,
